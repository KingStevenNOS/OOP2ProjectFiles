...
public class Customers extends Application{
	...
	public void start(Stage stage) throws Exception{
		...
		button1.setStyle("-fx-background-color: darksblue; -fx-text-fill: white; -fx-font-size->l3pt;");
		button2.setStyle("-fx-background-color: darksblue; -fx-text-fill: white; -fx-font-size->l3pt;");
